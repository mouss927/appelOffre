...
public class RegistrationResourceIntTest {
    ...
    private static final LocalDate DEFAULT_SUBCRIPTION_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_SUBCRIPTION_DATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public void setup() {
        ...
        RegistrationResource registrationResource = new RegistrationResource(registrationRepository, registrationSearchRepository);
    ...
    public static Registration createEntity(EntityManager em) {
        Registration registration = new Registration()
            .subcriptionDate(DEFAULT_SUBCRIPTION_DATE);
        return registration;
    }
    ...
    public void createRegistration() throws Exception {
        ...
        assertThat(testRegistration.getSubcriptionDate()).isEqualTo(DEFAULT_SUBCRIPTION_DATE);
        ...
        assertThat(registrationEs).isEqualToComparingFieldByField(testRegistration);
    }
    ...
    public void getAllRegistrations() throws Exception {
        ...
        restRegistrationMockMvc.perform(get("/api/registrations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].subcriptionDate").value(hasItem(DEFAULT_SUBCRIPTION_DATE.toString())));
    }
    ...
    public void getRegistration() throws Exception {
        ...
        restRegistrationMockMvc.perform(get("/api/registrations/{id}", registration.getId()))
            ...
            .andExpect(jsonPath("$.subcriptionDate").value(DEFAULT_SUBCRIPTION_DATE.toString()));
    }
    ...
    public void updateRegistration() throws Exception {
        ...
        updatedRegistration
            .subcriptionDate(UPDATED_SUBCRIPTION_DATE);
        ...
        Registration testRegistration = registrationList.get(registrationList.size() - 1);
        assertThat(testRegistration.getSubcriptionDate()).isEqualTo(UPDATED_SUBCRIPTION_DATE);
