...
import iut.fr.monappeloffre.repository.search.ProjectSearchRepository;
...
public class ProjectResourceIntTest {
    ...
    public void createProject() throws Exception {
        ...
        assertThat(testProject.getImages()).isEqualTo(DEFAULT_IMAGES);
        assertThat(testProject.getImagesContentType()).isEqualTo(DEFAULT_IMAGES_CONTENT_TYPE);
        assertThat(testProject.getDateSend()).isEqualTo(DEFAULT_DATE_SEND);
    ...
    public void updateProject() throws Exception {
        ...
        assertThat(testProject.getImages()).isEqualTo(UPDATED_IMAGES);
        assertThat(testProject.getImagesContentType()).isEqualTo(UPDATED_IMAGES_CONTENT_TYPE);
        assertThat(testProject.getDateSend()).isEqualTo(UPDATED_DATE_SEND);
